...
#get the altitude information and save it in the fourth column
...
df = df[["Latitude", "Longitude", "Elevation", df.columns[2]]]

# save to csv file
output_file_path = "Ladesaeulenregister_01.csv"
